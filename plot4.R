...
# make the plots, four of them this time
# change the locale to english to get the x-axis right
png(file="plot4.png")
...
# reset parameters so next plots work (there must be a better way)
par(mfrow=c(1,1))
